class ImportPluginPlConnectChatMessageItemController < ImportController

  @@child_helper    = ImportPluginPlConnectChatMessageItemHelper

  @@child_title     = "Import (Plugin ChatMessageItem)"
