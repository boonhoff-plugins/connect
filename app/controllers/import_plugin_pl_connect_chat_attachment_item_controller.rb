class ImportPluginPlConnectChatAttachmentItemController < ImportController

  @@child_helper    = ImportPluginPlConnectChatAttachmentItemHelper

  @@child_title     = "Import (Plugin ChatAttachmentItem)"
