class ImportPluginPlConnectChatReactionItemController < ImportController

  @@child_helper    = ImportPluginPlConnectChatReactionItemHelper

  @@child_title     = "Import (Plugin ChatReactionItem)"
