...
# CreatePluginPlConnectChatItem202609190704
class CreatePluginPlConnectChatItem202609190704 < ActiveRecord::Migration[8.1]
  def up
    # --- ---------------- ---
    # --- create variables ---
    # --- ---------------- ---
    ...
    table_name = 'pl_connect_chat_items'
    f_model_name = 'PlConnectChatItem'
    h_table_name = 'pl_connect_chat_item_histories'
    h_f_model_name = 'PlConnectChatItemHistory'
  ...
  SYSTEM[:server][:default][:enable_strong_parameter_filtering] = false
    ...
    ActiveRecord::Base.transaction do
      ...
      begin
        if ExtensionItem.exists?(name: extension_name, active: 1, del_flag: 0)
          ...
          ext_hash = { name: extension_name, decimal_position: count, tenant_id:, tenant_uuid:,
            uuid: 'b1d93f97-a5ca-4e7d-a2bd-838a9353d613--extension_item--20260919090445',
      ...
      if VersionItem.exists?(name: version_name)
        ...
        version_item = VersionItem.new.save_element(c:, check_uuid: false, element:
          { f_type: extension_type, name: version_name, uuid: '1acc2c5f-ab1d-4983-95d8-02f5ec763412--version_item--20260919090445',
      ...
      if Role.exists?(name: role_name)
        ...
        role = Role.new.save_element(c:, check_uuid: false, element: { f_type: 'controller', name: role_name,
          ...
          uuid: 'e85abe12-0dbb-44dc-931e-d86ac30cbfde--role--20260919090445', extension_item_id: extension_item.id, extension_item_uuid: extension_item.uuid })[:element]
        UserJoinRole.create(user_id: user_id, role_id: role.id, user_uuid: user_uuid, role_uuid: role.uuid, uuid: '8475126e-984c-43ec-a65d-c8440e8bc1a9--user_join_role--20260919090445')
      end
    ...
    lg_controller = LookupItemCreateHelper.group(c:, parent: lg_page, name: 'pl_connect_chat_item',
      ...
      f_type: I18n.t('fields.lookup_items.page_controller.f_type'), roles: l_admin_roles, uuid: '56a615c0-de38-4b1c-a65d-03875ca24479--lookup_item--20260919090445' )
    ...
    lg_f_type = LookupItemCreateHelper.group(c:, parent: lg_controller,
      ...
      f_type: I18n.t('fields.lookup_items.f_type.f_type'), uuid: '653690ac-d8ae-41a3-8a37-1032a60a7955--lookup_item--20260919090445', extension_item:,
    ...
    lg_state = LookupItemCreateHelper.group(c:, parent: lg_controller,
      ...
      f_type: I18n.t('fields.lookup_items.state.f_type'), uuid: '29dada9c-b1bb-42c0-9c5f-f9aec3d236a4--lookup_item--20260919090445', extension_item:,
    ...
    lg_search = LookupItemCreateHelper.group(c:, parent: lg_controller,
      ...
      f_type: I18n.t('fields.lookup_items.search_option.f_type'), uuid: '8ce08e9b-7d1f-4836-ba26-4f9182ab3605--lookup_item--20260919090445', extension_item:,
      ...
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        ...
        uuid: 'cb6f261a-8d31-4290-9b2c-62f3439b1ebe--lookup_item--20260919090445', extension_item:,
      ...
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        ...
        uuid: '858d7896-c57e-461f-8d05-d4a02c829ae7--lookup_item--20260919090445', extension_item:,
        title: 'Additionally link search fields', description: '', roles: l_admin_roles)
  
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        name: 'contains', decimal_position: '30',
        uuid: 'd15fac8d-93c2-4d87-b3ad-4e58139728b0--lookup_item--20260919090445', extension_item:,
      ...
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        ...
        uuid: 'fbc8ca80-c640-4a20-ad8f-5e6f0872e561--lookup_item--20260919090445', extension_item:,
      ...
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        ...
        uuid: '42954ff5-4251-4527-9815-2f487e777bc2--lookup_item--20260919090445', extension_item:,
      ...
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        ...
        uuid: '1f2c871f-e0bb-41e9-b5be-458e5e63baaf--lookup_item--20260919090445', extension_item:,
      ...
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        ...
        uuid: 'bb4a2329-f9b9-4483-8d5c-27f95ab1f054--lookup_item--20260919090445', extension_item:,
      ...
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        ...
        uuid: 'd55b090c-929d-4396-ac53-07aa73afc034--lookup_item--20260919090445', extension_item:,
      ...
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        ...
        uuid: 'e8b905d2-6c33-4997-9bce-a87dbe6b22b3--lookup_item--20260919090445', extension_item:,
      ...
      l_model_classes = LookupItemCreateHelper.lookup(c:, parent: lg_model_classes, name: lookup_name,
        uuid: '52d0cb0d-c275-465e-b3a7-0c0e834d6187--lookup_item--20260919090445', extension_item:,
      ...
      l_role_controller = LookupItemCreateHelper.lookup(c:, parent: lg_role_controller, name: lookup_name,
        uuid: '9eb027ff-d390-4445-a2d9-8609d6199d0f--lookup_item--20260919090445', extension_item:,
      ...
      begin
        if TemplateItem.exists?(name: model.underscore, f_type: 'controller')
          ...
          template_item = TemplateItem.create(name: model.underscore, decimal_position: count, creator_id: user_id, f_type: 'controller',
            ...
            title:, description: I18n.t('fields.template_items.description', title:), uuid: 'de6b6cf6-4300-4394-9849-94205c24640c--template_item--20260919090445',
      ...
      begin
        if DataItem.exists?(name: model.underscore, f_type: 'controller')
          ...
          data_item = DataItem.create(name: model.underscore, decimal_position: count, creator_id: user_id, updater_id: user_id,
            ...
            description: I18n.t('fields.data_items.description', title:), uuid: '554396c7-3f51-4d77-a52d-2a69c014d16d--data_item--20260919090445',
            extension_item_id: extension_item.id, extension_item_uuid: extension_item.uuid)
        end
      rescue StandardError => e
        puts e.message
  ...
  def down
    ActiveRecord::Base.transaction do
      ...
      LookupItem.where(yaml_key: "#{lg_page.name}.pl_connect_chat_item").delete_all
