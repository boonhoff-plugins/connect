...
# CreatePluginPlConnectChatMessageItem202609190750
class CreatePluginPlConnectChatMessageItem202609190750 < ActiveRecord::Migration[8.1]
  def up
    # --- ---------------- ---
    # --- create variables ---
    # --- ---------------- ---
    ...
    model = 'PlConnectChatMessageItem'
    ...
    table_name = 'pl_connect_chat_message_items'
    f_model_name = 'PlConnectChatMessageItem'
    h_table_name = 'pl_connect_chat_message_item_histories'
    h_f_model_name = 'PlConnectChatMessageItemHistory'
  ...
  SYSTEM[:server][:default][:enable_strong_parameter_filtering] = false
    ...
    ActiveRecord::Base.transaction do
      ...
      begin
        if ExtensionItem.exists?(name: extension_name, active: 1, del_flag: 0)
          ...
          ext_hash = { name: extension_name, decimal_position: count, tenant_id:, tenant_uuid:,
            uuid: 'aa62ba3d-6489-4b9f-8ba1-91987b8f1b12--extension_item--20260919095029',
      ...
      if VersionItem.exists?(name: version_name)
        ...
        version_item = VersionItem.new.save_element(c:, check_uuid: false, element:
          { f_type: extension_type, name: version_name, uuid: 'f31fcf48-9248-478c-8262-2da89590a81d--version_item--20260919095029',
      ...
      if Role.exists?(name: role_name)
        ...
        role = Role.new.save_element(c:, check_uuid: false, element: { f_type: 'controller', name: role_name,
          ...
          uuid: '4f4d4df5-6b59-4da3-aed4-373fb0be8efb--role--20260919095029', extension_item_id: extension_item.id, extension_item_uuid: extension_item.uuid })[:element]
        UserJoinRole.create(user_id: user_id, role_id: role.id, user_uuid: user_uuid, role_uuid: role.uuid, uuid: '823b39e6-f524-4eb9-9395-2c2f2cd64af1--user_join_role--20260919095029')
      end
    ...
    lg_controller = LookupItemCreateHelper.group(c:, parent: lg_page, name: 'pl_connect_chat_message_item',
      ...
      f_type: I18n.t('fields.lookup_items.page_controller.f_type'), roles: l_admin_roles, uuid: 'a0bd096c-7b76-4a33-9177-8c21199817d9--lookup_item--20260919095029' )
    ...
    lg_f_type = LookupItemCreateHelper.group(c:, parent: lg_controller,
      ...
      f_type: I18n.t('fields.lookup_items.f_type.f_type'), uuid: 'd357cfb4-7b1a-4fab-812d-f3c3a5e1e061--lookup_item--20260919095029', extension_item:,
    ...
    lg_state = LookupItemCreateHelper.group(c:, parent: lg_controller,
      ...
      f_type: I18n.t('fields.lookup_items.state.f_type'), uuid: '51756a06-824b-46f0-8596-6fffe1adad70--lookup_item--20260919095029', extension_item:,
    ...
    lg_search = LookupItemCreateHelper.group(c:, parent: lg_controller,
      ...
      f_type: I18n.t('fields.lookup_items.search_option.f_type'), uuid: '9c0bf4da-3259-4298-baad-c93933dd7f41--lookup_item--20260919095029', extension_item:,
      ...
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        ...
        uuid: 'bf74db5e-7664-4a69-a765-a3fcd40399f3--lookup_item--20260919095029', extension_item:,
      ...
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        ...
        uuid: '8b3b76a5-d4c3-4db7-bdc5-0cf00c4ef20e--lookup_item--20260919095029', extension_item:,
        title: 'Additionally link search fields', description: '', roles: l_admin_roles)
  
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        name: 'contains', decimal_position: '30',
        uuid: 'a5306f1e-63bb-42b4-9fa3-653a0682c907--lookup_item--20260919095029', extension_item:,
      ...
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        ...
        uuid: '48baf0f4-bbaf-448f-b954-bd6d2545bbf6--lookup_item--20260919095029', extension_item:,
      ...
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        ...
        uuid: '936d8a7d-9dc1-40f9-9389-06c14a0d2a68--lookup_item--20260919095029', extension_item:,
      ...
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        ...
        uuid: 'a6272db7-b59a-4f60-87c2-f17e31b68ccc--lookup_item--20260919095029', extension_item:,
      ...
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        ...
        uuid: 'f36e3eb5-3920-40c2-b83e-640aac3d97f8--lookup_item--20260919095029', extension_item:,
      ...
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        ...
        uuid: '1ada2652-4a6a-48f1-8177-666ce7e0c390--lookup_item--20260919095029', extension_item:,
      ...
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        ...
        uuid: 'ceefd7a2-eb65-4f71-b6b9-719d78803931--lookup_item--20260919095029', extension_item:,
      ...
      l_model_classes = LookupItemCreateHelper.lookup(c:, parent: lg_model_classes, name: lookup_name,
        uuid: '5a898404-b01f-4050-bbe6-39b32fed5b28--lookup_item--20260919095029', extension_item:,
      ...
      l_role_controller = LookupItemCreateHelper.lookup(c:, parent: lg_role_controller, name: lookup_name,
        uuid: 'cbd84dea-be46-4686-9e72-3cec48979f6c--lookup_item--20260919095029', extension_item:,
      ...
      begin
        if TemplateItem.exists?(name: model.underscore, f_type: 'controller')
          ...
          template_item = TemplateItem.create(name: model.underscore, decimal_position: count, creator_id: user_id, f_type: 'controller',
            ...
            title:, description: I18n.t('fields.template_items.description', title:), uuid: '73e6e1a9-3853-4df3-ade9-85b73c6077fc--template_item--20260919095029',
      ...
      begin
        if DataItem.exists?(name: model.underscore, f_type: 'controller')
          ...
          data_item = DataItem.create(name: model.underscore, decimal_position: count, creator_id: user_id, updater_id: user_id,
            ...
            description: I18n.t('fields.data_items.description', title:), uuid: '3e90aaba-5053-4e01-9fdb-71913b3bc7ff--data_item--20260919095029',
            extension_item_id: extension_item.id, extension_item_uuid: extension_item.uuid)
        end
      rescue StandardError => e
        puts e.message
  ...
  def down
    ActiveRecord::Base.transaction do
      ...
      LookupItem.where(yaml_key: "#{lg_page.name}.pl_connect_chat_message_item").delete_all
