...
# CreatePluginPlConnectChatMentionItem202609190754
class CreatePluginPlConnectChatMentionItem202609190754 < ActiveRecord::Migration[8.1]
  def up
    # --- ---------------- ---
    # --- create variables ---
    # --- ---------------- ---
    ...
    model = 'PlConnectChatMentionItem'
    title = 'ChatMentionItem'
    ...
    table_name = 'pl_connect_chat_mention_items'
    f_model_name = 'PlConnectChatMentionItem'
    h_table_name = 'pl_connect_chat_mention_item_histories'
    h_f_model_name = 'PlConnectChatMentionItemHistory'
  ...
  SYSTEM[:server][:default][:enable_strong_parameter_filtering] = false
    ...
    ActiveRecord::Base.transaction do
      ...
      begin
        if ExtensionItem.exists?(name: extension_name, active: 1, del_flag: 0)
          ...
          ext_hash = { name: extension_name, decimal_position: count, tenant_id:, tenant_uuid:,
            uuid: '9d571bf0-933c-4cca-9e26-42052b04092b--extension_item--20260919095418',
      ...
      if VersionItem.exists?(name: version_name)
        ...
        version_item = VersionItem.new.save_element(c:, check_uuid: false, element:
          { f_type: extension_type, name: version_name, uuid: '77b17955-9286-40b6-a220-c8554420ff3c--version_item--20260919095418',
      ...
      if Role.exists?(name: role_name)
        ...
        role = Role.new.save_element(c:, check_uuid: false, element: { f_type: 'controller', name: role_name,
          ...
          uuid: '45ccd49c-96de-47b1-ac36-e418d4d33b89--role--20260919095418', extension_item_id: extension_item.id, extension_item_uuid: extension_item.uuid })[:element]
        UserJoinRole.create(user_id: user_id, role_id: role.id, user_uuid: user_uuid, role_uuid: role.uuid, uuid: 'ff95f142-f9d8-427b-8c04-5b5b48262a87--user_join_role--20260919095418')
      end
    ...
    lg_controller = LookupItemCreateHelper.group(c:, parent: lg_page, name: 'pl_connect_chat_mention_item',
      ...
      f_type: I18n.t('fields.lookup_items.page_controller.f_type'), roles: l_admin_roles, uuid: '5d43d11a-ff9d-427a-837a-6cedf192f36e--lookup_item--20260919095418' )
    ...
    lg_f_type = LookupItemCreateHelper.group(c:, parent: lg_controller,
      ...
      f_type: I18n.t('fields.lookup_items.f_type.f_type'), uuid: '9f3200d3-016c-4bc1-a5d2-e39142f14e27--lookup_item--20260919095418', extension_item:,
    ...
    lg_state = LookupItemCreateHelper.group(c:, parent: lg_controller,
      ...
      f_type: I18n.t('fields.lookup_items.state.f_type'), uuid: '03348e3a-e467-4e8c-bedb-ac6104f4d750--lookup_item--20260919095418', extension_item:,
    ...
    lg_search = LookupItemCreateHelper.group(c:, parent: lg_controller,
      ...
      f_type: I18n.t('fields.lookup_items.search_option.f_type'), uuid: 'a8026a5c-ee47-4980-838c-57d083c5fd90--lookup_item--20260919095418', extension_item:,
      ...
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        ...
        uuid: 'e9c0c928-98a1-4a79-aa03-03391aef06d5--lookup_item--20260919095418', extension_item:,
      ...
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        ...
        uuid: '0bc82936-2e7c-47b9-8867-6f4e8d1e1f97--lookup_item--20260919095418', extension_item:,
        title: 'Additionally link search fields', description: '', roles: l_admin_roles)
  
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        name: 'contains', decimal_position: '30',
        uuid: '119ce8e3-2dea-417a-98d5-0df02cf63beb--lookup_item--20260919095418', extension_item:,
      ...
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        ...
        uuid: '7eba7b24-ae07-4708-8bc8-2d5abbab7506--lookup_item--20260919095418', extension_item:,
      ...
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        ...
        uuid: 'd6e0b97c-3b25-4d6e-b4d2-eee313624a7d--lookup_item--20260919095418', extension_item:,
      ...
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        ...
        uuid: '4f7e53b2-ed78-4e42-850c-95988cd2f515--lookup_item--20260919095418', extension_item:,
      ...
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        ...
        uuid: 'bcb23809-150d-48de-83d4-4966e4dc59d8--lookup_item--20260919095418', extension_item:,
      ...
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        ...
        uuid: '8380dcf2-c2fc-4e93-bf7b-90da4a35e112--lookup_item--20260919095418', extension_item:,
      ...
      lookup_item = LookupItemCreateHelper.lookup(c:, parent: lg_search, f_type: "symbol_lookup",
        ...
        uuid: '93444a77-7630-4f23-845c-3aa43b36d38b--lookup_item--20260919095418', extension_item:,
      ...
      l_model_classes = LookupItemCreateHelper.lookup(c:, parent: lg_model_classes, name: lookup_name,
        uuid: '295d96ac-a66a-4f8f-9653-978313a97312--lookup_item--20260919095418', extension_item:,
      ...
      l_role_controller = LookupItemCreateHelper.lookup(c:, parent: lg_role_controller, name: lookup_name,
        uuid: '053514cb-76a6-432b-977a-234b45634423--lookup_item--20260919095418', extension_item:,
      ...
      begin
        if TemplateItem.exists?(name: model.underscore, f_type: 'controller')
          ...
          template_item = TemplateItem.create(name: model.underscore, decimal_position: count, creator_id: user_id, f_type: 'controller',
            ...
            title:, description: I18n.t('fields.template_items.description', title:), uuid: 'c6f3faa4-dfa8-43ff-9089-8fc2acbd7a15--template_item--20260919095418',
      ...
      begin
        if DataItem.exists?(name: model.underscore, f_type: 'controller')
          ...
          data_item = DataItem.create(name: model.underscore, decimal_position: count, creator_id: user_id, updater_id: user_id,
            ...
            description: I18n.t('fields.data_items.description', title:), uuid: '86ad7f34-e127-498b-b6b4-3c3960685a10--data_item--20260919095418',
            extension_item_id: extension_item.id, extension_item_uuid: extension_item.uuid)
        end
      rescue StandardError => e
        puts e.message
  ...
  def down
    ActiveRecord::Base.transaction do
      ...
      LookupItem.where(yaml_key: "#{lg_page.name}.pl_connect_chat_mention_item").delete_all
